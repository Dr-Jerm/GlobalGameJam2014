...
public class StarThirdPersonCamera : MonoBehaviour
{
...
//    private bool snap = false;
    private StarThirdPersonController shipcontroller;
//    private float targetHeight = 100000.0f;
    ...
    void OnEnable()
    {
		...
		newCamPostion.z = cameraTransform.position.z;
		print (cameraTransform.position.x);
...
//        if (_target)
//        {
//			shipcontroller = _target.GetComponent<ThirdPersonController>();
//        }
//
//		if (shipcontroller)
//        {
...
//        Cut(_target, centerOffset);
	...
	void Awake ()
	{
		...
		_target = gameObject.rigidbody.transform;
	}
	void FixedUpdate ()
	{
		if (_target != null) 
		{
			newCamPostion.x = _target.position.x;
			newCamPostion.y = _target.position.y;


			cameraTransform.position = newCamPostion;
			cameraTransform.rotation = _target.rotation;
		}
	}
